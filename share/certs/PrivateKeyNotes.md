...
unlocked to sign the HodlCash-Qt.app bundle.
...
allowing somebody to distribute a HodlCash-Qt.app or hodlcash-qt-setup.exe with a valid
...
that the hodlcash-qt.exe file inside the installer had not been tampered with.
