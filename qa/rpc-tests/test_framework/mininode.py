# mininode.py - HodlCash P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a hodlcash node
...
# Objects that map to hodlcashd objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in hodlcashd indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest"):
        ...
        print 'MiniNode: Connecting to HodlCash Node IP # ' + dstaddr + ':' \
            + str(dstport)
