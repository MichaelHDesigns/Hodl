...
class HTTPBasicsTest (HodlCashTestFramework):        
    ...
    def run_test(self):        
        ...
        out1 = conn.getresponse().read();
        assert_equal('"error":null' in out1, True)
        assert_equal(conn.sock!=None, True) #connection must be closed because hodlcashd should use keep-alive by default
