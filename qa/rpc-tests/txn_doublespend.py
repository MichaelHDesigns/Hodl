...
class TxnMallTest(HodlCashTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 HODL:
        ...
        # First: use raw transaction API to send 1210 HODL to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50HODL for another
        ...
        # Node0's total balance should be starting balance, plus 100HODL for 
