...
###   This script attempts to download the signature file SHA256SUMS.asc from hodlcash.com
...
WORKINGDIR="/tmp/hodlcash"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://hodlcash.com/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://hodlcash.com/bin/"
VERSIONPREFIX="hodlcash-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'hodlcash-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[hodlcash-]<version>-[rc[0-9]] (example: hodlcash-0.9.2-rc1)"
   echo "wget output:"
