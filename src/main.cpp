...
const string strMessageMagic = "HodlCash Signed Message:\n";
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if(nHeight < 5)			{ return 1000000 * COIN;}
    if(nHeight < 100 && nHeight > 5)	{ return 25 * COIN;}
    if(nHeight < 201 && nHeight > 100)	{ return 25 * COIN;}  //6% Investor Payout.
    if(nHeight < 7884000 && nHeight > 201){ return 25 * COIN;}
