...
#ifndef HODLCASH_QT_HODLCASHUNITS_H
#define HODLCASH_QT_HODLCASHUNITS_H
...
*/
class HodlCashUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit HodlCashUnits(QObject *parent);

    /** HodlCash units.
      @note Source: https://en.hodlcash.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        HODL,
...
typedef HodlCashUnits::Unit HodlCashUnit;

#endif // HODLCASH_QT_HODLCASHUNITS_H
