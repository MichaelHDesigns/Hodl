    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("HODL Coin - Core");
    QString versionText     = QString("Version %1").arg(QString::fromStdString(FormatFullVersion()));
    QString copyrightText  = QChar(0xA9)+QString("2017-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The HODL coin developers"));
    ...
    const char *inspirationals[] = {
        "HODL Coin is Different"
    };

    srand(time(NULL)+clock());
    QString inspirationalText  = QString(inspirationals[rand() % 1]);
    QString authorText = QString("https://HODL-Coin.com");
    ...
    // draw the hodlcash icon, expected size of PNG: 1024x1024
