...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatHodlCashURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + HodlCashUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatHodlCashURI(info));
}
