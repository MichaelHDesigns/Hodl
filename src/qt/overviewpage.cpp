...
class TxViewDelegate : public QAbstractItemDelegate
{
	Q_OBJECT
public:
	TxViewDelegate(): QAbstractItemDelegate(), unit(HodlCashUnits::HODL)
	{
			...
			const QModelIndex &index ) const
	{
		...
		painter->setPen(foreground);
		QString amountText = HodlCashUnits::formatWithUnit(unit, amount, true, HodlCashUnits::separatorAlways);
		if(!confirmed)
		{
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance, std::vector<COutput> termDepositInfo)
{
	...
	ui->labelBalance->setText(HodlCashUnits::formatWithUnit(unit, balance, false, HodlCashUnits::separatorAlways));
	ui->labelUnconfirmed->setText(HodlCashUnits::formatWithUnit(unit, unconfirmedBalance, false, HodlCashUnits::separatorAlways));
	ui->labelImmature->setText(HodlCashUnits::formatWithUnit(unit, immatureBalance, false, HodlCashUnits::separatorAlways));
	ui->labelTotal->setText(HodlCashUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, HodlCashUnits::separatorAlways));
	ui->labelWatchAvailable->setText(HodlCashUnits::formatWithUnit(unit, watchOnlyBalance, false, HodlCashUnits::separatorAlways));
	ui->labelWatchPending->setText(HodlCashUnits::formatWithUnit(unit, watchUnconfBalance, false, HodlCashUnits::separatorAlways));
	ui->labelWatchImmature->setText(HodlCashUnits::formatWithUnit(unit, watchImmatureBalance, false, HodlCashUnits::separatorAlways));
	ui->labelWatchTotal->setText(HodlCashUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, HodlCashUnits::separatorAlways));
...
void OverviewPage::setTermDeposit(std::vector<COutput>& termDepositInfo) {
	...
	ui->labellocked->setText(HodlCashUnits::formatWithUnit(unit, totalLocked, false, HodlCashUnits::separatorAlways));
	ui->labelaccrued->setText(HodlCashUnits::formatWithUnit(unit, totalAccrued, false, HodlCashUnits::separatorAlways));
	ui->labelMatured->setText(HodlCashUnits::formatWithUnit(unit, totalMatured, false, HodlCashUnits::separatorAlways));
