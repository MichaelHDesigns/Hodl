...
#ifndef HODLCASH_SCRIPT_STANDARD_H
#define HODLCASH_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a CHodlCashAddress
 */
...
#endif // HODLCASH_SCRIPT_STANDARD_H
