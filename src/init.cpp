...
void Shutdown()
{
    ...
    GenerateHodlCashs(false, NULL, 0);
#endif
    StopNode();
...
std::string HelpMessage(HelpMessageMode mode)
{
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), "hodlcashd.pid"));
#endif
    ...
    strUsage += HelpMessageGroup(_("RPC SSL options: (see the HodlCash Wiki for SSL setup instructions)"));
...
{
    return FormatParagraph(_("Download latest wallet: <https://hodlcash.com/hodlcash-downloads/>")) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           FormatParagraph(strprintf(_("Copyright (C) 2017-%i The HodlCash Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
           ...
           "\n" + "\n" + "\n" +"\n"+
           FormatParagraph(_("For more information please visit and join us at <https://hodlcash.com/>")) + "\n" + "\n";
}
...
bool InitSanityCheck(void)
{
    if(!ECC_InitSanityCheck()) {
        InitError("OpenSSL appears to lack support for elliptic curve cryptography. For more "
                  "information, visit https://en.hodlcash.it/wiki/OpenSSL_and_EC_Libraries");
        return false;
    }
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Sanity check
    if (!InitSanityCheck())
        return InitError(_("Initialization sanity check failed. HodlCash is shutting down."));
    ...
    try {
        ...
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. HodlCash Core is probably already running.") + " %s.", strDataDir, e.what()));
    }
    ...
    if (pwalletMain)
        GenerateHodlCashs(GetBoolArg("-gen", false), pwalletMain, GetArg("-genproclimit", -1));
#endif
