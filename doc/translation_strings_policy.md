...
This document provides guidelines for internationalization of the HodlCash Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `hodlcash_en.ts` remains unchanged.
