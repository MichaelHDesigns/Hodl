The following is a list of assets used in the hodlcash source and their proper attribution.
...
* HodlCash Icon: (based on the original hodlcash logo from Bitboy)
* Some icons are based on Stephan Hutchings Typicons
* License: MIT

### Assets Used
    src/qt/res/icons/about.png, src/qt/res/icons/about_qt.png,
    src/qt/res/icons/hodlcash.icns, src/qt/res/icons/hodlcash.ico,
    src/qt/res/icons/hodlcash.png, src/qt/res/icons/clock*.png,
    ...
    src/qt/res/src/verify.svg, src/qt/res/src/hodlcash.svg,
